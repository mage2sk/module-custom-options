<?php
/**
 * Standalone install + heartbeat reporter for Panth_CustomOptions.
 *
...
namespace Panth\CustomOptions\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_CustomOptions';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-custom-options';
